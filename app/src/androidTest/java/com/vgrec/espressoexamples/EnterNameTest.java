...
public class EnterNameTest extends BaseTest {
    ...
    public void testGreetingMessageWithNameDisplayed() {
        ...
        clickViewWithId(R.id.next_button);
        checkViewWithIdByText(R.id.greeting_message,GREETING_MESSAGE);
    }
}
